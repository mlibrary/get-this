...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<yabeda>.freeze, ["~> 0.5".freeze])
  s.add_runtime_dependency(%q<puma>.freeze, [">= 0".freeze])
  ...
  s.add_development_dependency(%q<yabeda-prometheus>.freeze, ["~> 0.8".freeze])
end
